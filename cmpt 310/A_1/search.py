...
class Cube:
    ...
    def actions(self, state):
        ...
        many actions, consider yielding them one at a time in an
        iterator, rather than building them all at once."""
        return [rotateTopAntiClockwise(),rotateTopClockwise(), rotateBottomAntiClockwise(),rotateBottomClockwise(),rotateRightClockwise(),
        rotateRightAntiClockwise,rotateLeftAntiClockwise(),rotateLeftClockwise(),rotateLeftClockwise(),rotateLeftAntiClockwise(),facet0AntiClockwise(),
        facet0Clockwise(),facet4Clockwise() ]
