...
def Rotate_Face_2_AnticlockwiseClockwise(state): # 4,0 and 4,1 #facet 2
    newState = copy.deepcopy(state)
    temp = copy.deepcopy(state)

    newState[1][1] = temp [0][3]
    newState[1][3] = temp [0][2]
    newState[0][2] = temp [3][0]
    newState[0][3] = temp [3][2]
    newState[3][0] = temp [4][1]
    newState[3][2] = temp [4][0]
    newState[4][1] = temp [1][3]
    newState[4][0] = temp [1][1]

    newState[2][0] = temp [2][1]
    newState[2][3] = temp [2][2]
    newState[2][2] = temp [2][0]
    newState[2][1] = temp [2][3]
    return newState

def Rotate_Face_2_clockwisewise(state):
   
    return Rotate_Face_2_AnticlockwiseClockwise(Rotate_Face_2_AnticlockwiseClockwise(Rotate_Face_2_AnticlockwiseClockwise(state)))


def Rotate_Face_5_Anticlockwise(state): # 4,2 and 4,3 #facet 5
    newState = copy.deepcopy(state)
    temp = copy.deepcopy(state)


    newState[3][3] = temp [0][1]
    newState[3][1] = temp [0][0]
    newState[0][0] = temp [1][2]
    newState[0][1] = temp [1][0] 
    newState[4][3] = temp [3][1] 
    newState[4][2] = temp [3][3]
    newState[1][0] = temp [4][2] 
    newState[1][2] = temp [4][3] 

    newState[5][1] = temp [5][3]
    newState[5][2] = temp [5][0]
    newState[5][3] = temp [5][2]
    newState[5][0] = temp [5][1]

    return newState

def Rotate_Face_5_clockwise(state):
    

   return  Rotate_Face_5_Anticlockwise( Rotate_Face_5_Anticlockwise(Rotate_Face_5_Anticlockwise(state)))
 

def Rotate_Face_3_clockwise(state): #2,1 and 2,3 #facet 3
    newState = copy.deepcopy(state)
    temp = copy.deepcopy(state)


    newState[0][1] = temp [2][1]
    newState[0][3] = temp [2][3]
    newState[2][1] = temp [4][1]
    newState[2][3] = temp [4][3] 
    newState[4][1] = temp [5][1]
    newState[4][3] = temp [5][3] 
    newState[5][1] = temp [0][1]
    newState[5][3] = temp [0][3] 

    newState[3][1] = temp [3][0]
    newState[3][2] = temp [3][3]
    newState[3][3] = temp [3][1]
    newState[3][0] = temp [3][2]
    return newState

def Rotate_Face_3_Anticlockwise(state):

   return Rotate_Face_3_clockwise(    Rotate_Face_3_clockwise(    Rotate_Face_3_clockwise(state)))
  

def Rotate_Face_1_Anticlockwise(state): # 2,0 and 2,2 facet 1
    newState = copy.deepcopy(state)
    temp = copy.deepcopy(state)


    newState[0][0] = temp [2][0]
    newState[0][2] = temp [2][2]
    newState[2][0] = temp [4][0]
    newState[2][2] = temp [4][2]
    newState[4][0] = temp [5][0]
    newState[4][2] = temp [5][2]
    newState[5][0] = temp [0][0]
    newState[5][2] = temp [0][2]

    newState[1][1] = temp [1][3]
    newState[1][2] = temp [1][0]
    newState[1][3] = temp [1][2]
    newState[1][0] = temp [1][1]
    return newState

def Rotate_Face_1_clockwise(state):
    return Rotate_Face_1_Anticlockwise(    Rotate_Face_1_Anticlockwise(    Rotate_Face_1_Anticlockwise(state)))
    


def Rotate_Face_0_Anticlockwise(state): #2,1 and 2,0 #facet 0
    newState = copy.deepcopy(state)
    temp = copy.deepcopy(state)

    newState[1][0] = temp [5][3]
    newState[1][1] = temp [5][2]
    newState[2][0] = temp [1][0]
    newState[2][1] = temp [1][1]
    newState[3][0] = temp [2][0]
    newState[3][1] = temp [2][1]
    newState[5][2] = temp [3][1]
    newState[5][3] = temp [3][0]

    newState[0][1] = temp [0][3]
    newState[0][2] = temp [0][0]
    newState[0][3] = temp [0][2]
    newState[0][0] = temp [0][1]
    return newState

def Rotate_Face_0_clockwise(state):
   
    return Rotate_Face_0_Anticlockwise( Rotate_Face_0_Anticlockwise(Rotate_Face_0_Anticlockwise(state)))
     


def Rotate_Face_4_Anticlockwise(state): #2,2 and 2,3 facet 4
    newState = copy.deepcopy(state)
    temp = copy.deepcopy(state)

    newState[2][2] = temp [3][2]
    newState[2][3] = temp [3][3]
    newState[1][2] = temp [2][2]
    newState[1][3] = temp [2][3]
    newState[3][2] = temp [5][1]
    newState[3][3] = temp [5][0]
    newState[5][1] = temp [1][2]
    newState[5][0] = temp [1][3]

    newState[4][0] = temp [4][1]
    newState[4][3] = temp [4][2]
    newState[4][2] = temp [4][0]
    newState[4][1] = temp [4][3]
    return newState

def Rotate_Face_4_clockwise(state):
    # return Rotate_Face_4_Anticlockwise(    Rotate_Face_4_Anticlockwise(    Rotate_Face_4_Anticlockwise(node)))
    newState = Rotate_Face_4_Anticlockwise(Rotate_Face_4_Anticlockwise(Rotate_Face_4_Anticlockwise(state)))
    return newState
...
class Cube(Problem):
    ...
    def actions(self, state):
        ...
        return ['Rotate_Face_2_AnticlockwiseClockwise','Rotate_Face_2_clockwisewise', 'Rotate_Face_5_Anticlockwise','Rotate_Face_5_clockwise','Rotate_Face_3_clockwise',
        'Rotate_Face_3_Anticlockwise','Rotate_Face_1_Anticlockwise','Rotate_Face_1_clockwise','Rotate_Face_1_clockwise','Rotate_Face_0_Anticlockwise',
        'Rotate_Face_0_clockwise()','Rotate_Face_4_clockwise' ,'Rotate_Face_4_Anticlockwise']
    ...
    def result(self, state, action):
        ...
        self.actions(state)."""
        newNode = Node(state)
        copy_node = copy.deepcopy(newNode)
        
        
       
         
        if(action == 'Rotate_Face_2_AnticlockwiseClockwise'):
            newNode.state = (Rotate_Face_2_AnticlockwiseClockwise(copy_node.state))
        if(action == 'Rotate_Face_2_clockwisewise'):
             newNode.state = Rotate_Face_2_clockwisewise(newNode.state)
        if(action == 'Rotate_Face_5_Anticlockwise'):
            newNode.state =  Rotate_Face_5_Anticlockwise(newNode.state)
        if(action == 'Rotate_Face_5_clockwise'):
             newNode.state = Rotate_Face_5_clockwise(newNode.state)
        if(action == 'Rotate_Face_3_clockwise'):
            newNode.state =  Rotate_Face_3_clockwise(newNode.state)
        if(action == 'Rotate_Face_3_Anticlockwise'):
             newNode.state = Rotate_Face_3_Anticlockwise(newNode.state)
        if(action == 'Rotate_Face_1_Anticlockwise'):
             newNode.state = Rotate_Face_1_Anticlockwise(newNode.state)
        if(action == 'Rotate_Face_1_clockwise'):
            newNode.state =  Rotate_Face_1_clockwise(newNode.state)
        if(action == 'Rotate_Face_0_Anticlockwise'):
            newNode.state = Rotate_Face_0_Anticlockwise(newNode.state)
        if(action == 'Rotate_Face_0_clockwise'):
            newNode.state =  Rotate_Face_0_clockwise(newNode.statede)
        if(action == 'Rotate_Face_4_clockwise'):
             newNode.state = Rotate_Face_4_clockwise(newNode.state)
        if(action == 'Rotate_Face_4_Anticlockwise'):
             newNode.state = Rotate_Face_4_Anticlockwise(newNode.state)
    ...
    def goal_test(self, state):
        ...
        #     return is_in(state, self.goal)
        # else:
        #     return state == self.goal before

        n = Node(state)
    
        heur = self.h_4(n)
        return (heur == self.goal)
...
class Node:
    ...
    def __init__(self, state, parent=None, action=None, action_desc=None, path_cost=0):
        """Create a search tree Node, derived from a parent by an action."""
        self.state = state
        self.parent = parent
        self.action = action
        self.action_desc = action_desc # a descriptor (e.g: turn facet 1 clockwise) for the step taken
    ...
    def steps(self):
        """Return the sequence of actions to go from the root to this node."""
        return [node.action_desc for node in self.path()[1:]]
    ...
    while frontier:
        ...
        if problem.goal_test(node.state):
            # if display:
                ...
                print("Answer depth: ",len(node.steps()))
...
def astar_search(problem, h=None, display=True):
    ...
    return best_first_graph_search(problem, lambda n: n.path_cost + h(n), True)
...
class StagePuzzle(Problem):
    ...
    def ma_h(self, node):
        key_value_pairs = { 1:[0,1], 2:[0,2], 3:[1,0], 4:[1,1], 5:[1,2], 6:[1,3], 7:[2,0], 8:[2,1], 9:[2,2], 0:[2,3]}
        actual_pairs = [[0,1], [0,2], [1,0], [1,1], [1,2], [1,3], [2,0], [2,1], [2,2], [2,3]]
        temp = []
        blank_space = 0
        state = node.state
        for i in state:
            if state[i] == 0:
                blank_space = i
            temp.append(key_value_pairs.get(i))
        heuristic = 0
        for i in range(9):
            for j in range(2):
                if(state[i]==0):
                    ...
                    heuristic += abs(temp[i][j]-actual_pairs[i][j])
        return heuristic

    def max_h(self, node):
        return max(self.h(node), self.ma_h(node))
